...
Enjine.Resources = {
    Images: {}, Sounds: {}, Destroy: function () {
        delete this.Images;
        delete this.Sounds;
        return this
...
Enjine.GameTimer.prototype = {
    Start: function () {
        ...
        if (this.UpdateObject != null) {
            var a = (new Date).getTime(), b = (a - this.LastTime) / 1E3;
            this.LastTime = a;
...
Enjine.DrawableManager.prototype = {
    Add: function (a) {
        ...
        for (var b =
            0, c = 0, c = 0; c < a.length;) for (b = 0; b < this.Objects.length; b++) if (this.Objects[b] === a[c]) {
