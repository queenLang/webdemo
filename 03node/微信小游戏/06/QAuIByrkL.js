var Mario = {
    SpriteCuts: {
        CreateBlackFont: function () {
            ...
            for (var a =
                [], b = 0, c = 0, e = Enjine.Resources.Images.background.width / 32, d = Enjine.Resources.Images.background.height / 32, b = 0; b < e; b++) {
                a[b] = [];
    ...
    Tile: {
        BlockUpper: 1, BlockAll: 2, BlockLower: 4, Special: 8, Bumpable: 16, Breakable: 32, PickUpable: 64,
        Animated: 128, Behaviors: [], LoadBehaviors: function () {
...
Mario.BackgroundGenerator.prototype = {
    SetValues: function (a, b, c, e) {
        ...
        } else for (b = 0; b < this.Width; b++) for (c = 0; c < this.Height; c++) {
            e = b % 2;
            d = c - 1;
            if (d < 0 || d > 7) d = 7, e = 0;
            e === 0 && d > 1 && d < 5 && (e = -1, d = 0);
        ...
        var b = 0, c = 0, e = 0, d = 0;
        if (this.Distant) for (b = 0; b < this.Width; b++) for (c = 0; c < this.Height; c++) e = b % 2, d = c - 1, d > 2 && d < 5 ? d = 2 : d >= 5 && (d -= 2), d < 0 ? (e = 0, d = 5) : d > 4 ? (e = 1, d = 5) : e < 1 && d === 3 ? (e = 0, d = 3) : e < 1 && d > 0 && d < 3 && (e = 0,
            d = 2), a.SetBlock(b, c, 1 + e + (d + 4) * 8); else for (b = 0; b < this.Width; b++) for (c = 0; c < this.Height; c++) e = b % 3, d = c - 1, d > 2 && d < 5 ? d = 2 : d >= 5 && (d -= 2), d < 0 ? (e = 1, d = 5) : d > 4 ? (e = 2, d = 5) : e < 2 && d === 4 ? (e = 2, d = 4) : e < 2 && d > 0 && d < 4 && (e = 4, d = -3), a.SetBlock(b, c, 1 + e + (d + 3) * 8)
    }
};
...
Mario.BackgroundRenderer.prototype.Draw = function (a, b) {
    for (var c = b.X / this.Distance, e = 0, d = 0, f = null, f = null, g = (c + this.Width) / 32 | 0, e = c / 32 | 0; e <= g; e++) for (d = 0; d < this.TilesY; d++) f = this.Level.GetBlock(e, d) & 255, f = this.Background[f % 8][f / 8 | 0], a.drawImage(Enjine.Resources.Images.background, f.X, f.Y, f.Width, f.Height, (e << 5) - c | 0, d << 5 | 0, f.Width, f.Height)
};
...
Mario.ImprovedNoise.prototype = {
    Shuffle: function () {
        ...
        var e = (a | 0) & 255, d = (b | 0) & 255, f = (c | 0) & 255;
        a -= a | 0;
        b -= b | 0;
        c -= c | 0;
        var g = this.Fade(a), h = this.Fade(b), i = this.Fade(c), j = this.P[e] + d, k = this.P[j] + f,
            j = this.P[j + 1] + f, d = this.P[e + 1] + d, e =
            this.P[d] + f, f = this.P[d + 1] + f;
...
Mario.Character.prototype.Move = function () {
    if (this.WinTime > 0) this.WinTime++, this.Ya = this.Xa = 0; else if (this.DeathTime > 0) this.DeathTime++, this.DeathTime < 11 ? this.Ya = this.Xa = 0 : this.DeathTime === 11 ? this.Ya = -15 : this.Ya += 2, this.X += this.Xa, this.Y += this.Ya; else if (this.PowerUpTime !== 0) {
        ...
        if (this.Xa < -2) this.Facing = -1;
        if (Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.S) || this.JumpTime < 0 && !this.OnGround && !this.Sliding) if (this.JumpTime < 0) this.Xa = this.XJumpSpeed, this.Ya = -this.JumpTime * this.YJumpSpeed, this.JumpTime++;
        else if (this.OnGround && this.MayJump) Enjine.Resources.PlaySound("jump"), this.XJumpSpeed = 0, this.YJumpSpeed = -1.9, this.JumpTime = 7, this.Ya = this.JumpTime * this.YJumpSpeed, this.Sliding = this.OnGround = !1; else if (this.Sliding && this.MayJump) Enjine.Resources.PlaySound("jump"), this.XJumpSpeed = -this.Facing * 6, this.YJumpSpeed = -2, this.JumpTime = -6, this.Xa = this.XJumpSpeed, this.Ya = -this.JumpTime * this.YJumpSpeed, this.Sliding = this.OnGround = !1, this.Facing = -this.Facing; else {
        ...
        if (!Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.Left) && !Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.Right) || this.Ducking || this.Ya < 0 || this.OnGround) this.Sliding =
            !1;
...
Mario.Character.prototype.CalcPic = function () {
    ...
    if (this.OnGround && (this.Facing === -1 && this.Xa > 0 || this.Facing === 1 && this.Xa < 0)) {
        ...
        if (this.Xa > 3 || this.Xa < -3) for (b = 0; b < 3; b++) this.World.AddSprite(new Mario.Sparkle(this.World, this.X + Math.random() * 8 - 4 | 0, this.Y + Math.random() * 4 | 0, Math.random() * 2 - 1, Math.random() * -1, 0, 1, 5))
    }
...
Mario.Character.prototype.SubMove = function (a, b) {
    ...
    if (b < 0) if (this.IsBlocking(this.X +
        a, this.Y + b - this.Height, a, b)) c = !0; else if (c || this.IsBlocking(this.X + a - this.Width, this.Y + b - this.Height, a, b)) c = !0; else if (c || this.IsBlocking(this.X + a + this.Width, this.Y + b - this.Height, a, b)) c = !0;
...
Mario.Character.prototype.IsBlocking = function (a, b, c, e) {
    var d = !1, f = d = d = 0, a = a / 16 | 0, b = b / 16 | 0;
...
Mario.LevelRenderer.prototype.DrawStatic = function (a, b) {
    for (var c = 0, e = 0, d = 0, d = null, f = (b.X + this.Width) / 16 | 0, c = b.X / 16 | 0; c < f + 1; c++) for (e = 0; e < this.TilesY; e++) d = this.Level.GetBlock(c, e) & 255, (Mario.Tile.Behaviors[d] & Mario.Tile.Animated) === 0 && (d = this.Background[d % 16][d / 16 | 0], a.drawImage(Enjine.Resources.Images.map, d.X, d.Y, d.Width, d.Height, (c << 4) - b.X | 0, e << 4 | 0, d.Width, d.Height))
};
Mario.LevelRenderer.prototype.DrawDynamic = function (a, b) {
    for (var c = 0, e = 0, d = 0, f = 0, g = 0, d = null, c = b.X / 16 | 0; c <= (b.X + this.Width) / 16 | 0; c++) for (e = b.Y / 16 | 0; e <= (b.Y + this.Height) / 16 | 0; e++) d = this.Level.GetBlock(c, e), (Mario.Tile.Behaviors[d & 255] & Mario.Tile.Animated) > 0 && (f = (this.Bounce / 3 | 0) % 4, (d % 16 / 4 | 0) === 0 && (d / 16 | 0) === 1 && (f = (this.Bounce / 2 + (c + e) / 8 | 0) % 20, f > 3 && (f = 0)), (d % 16 / 4 | 0) === 3 && (d / 16 | 0) === 0 && (f = 2), g = 0, c >= 0 && e >= 0 && c < this.Level.Width && e < this.Level.Height && (g = this.Level.Data[c][e]), g > 0 && (g = Math.sin((g - this.Delta) /
...
Mario.LevelGenerator.prototype = {
    CreateLevel: function (a, b) {
        var c = 0, e = 0, d = c = 0, f = 0, g = 0, h = 0, i = null;
        this.Type = a;
        this.Difficulty = b;
        ...
        if (a === Mario.LevelType.Castle || a === Mario.LevelType.Underground) for (d = 0; d < i.Width; d++) {
        ...
        for (var c = (Math.random() * 4 | 0) + 2, e = c * 2 + ((Math.random() * 2 | 0) + 2), d = 0, f =
            0, g = (Math.random() * 3 | 0) === 0, h = this.Height - 1 - (Math.random() * 4 | 0), d = b; d < b + e; d++) if (d < b + c || d > b + e - c - 1) for (f = 0; f < this.Height; f++) f >= h ? a.SetBlock(d, f, 145) : g && (d < b + c ? f >= h - (d - b) + 1 && a.SetBlock(d, f, 9) : f >= h - (b + e - d) + 2 && a.SetBlock(d, f, 9));
        return e
    }, BuildCannons: function (a, b, c) {
        alert("cannons");
        var e = (Math.random() * 10 | 0) + 2, d = this.Height - 1 - Math.random() * 4 | 0,
            f = b + 1 + Math.random() * 4 | 0, g = 0, h = 0, i = 0;
        e > c && (e = c);
        for (g = b; g < b + e; g++) {
        ...
        var e = (Math.random() * 10 | 0) + 10, d = this.Height - 1 - Math.random() * 4 | 0, f = 0, g = 0, h = d, i = !0,
            j = 0, k = 0, l = [], m = 0, n = 0;
        e > c && (e = c);
        for (f = b; f < b + e; f++) for (g = 0; g < this.Height; g++) g >= d && a.SetBlock(f, g, 145);
        for (this.AddEnemyLine(a, b + 1, b + e - 1, d - 1); i;) if (h = h - 2 - Math.random() * 3 | 0, h <= 0) i = !1; else if (j = (Math.random() * 5 | 0) + 3, k = (Math.random() * (e - j - 2) | 0) + b + 1, l[k - b] || l[k - b + j] || l[k - b -
        1] || l[k - b + j + 1]) i = !1; else {
            l[k - b] = !0;
            l[k - b + j] = !0;
            this.AddEnemyLine(a, k, k + j, h - 1);
            (Math.random() * 4 | 0) === 0 && (this.Decorate(a, k - 1, k + j + 1, h), i = !1);
            for (f = k; f < k + j; f++) for (g = h; g < d; g++) m = 5, n = 9, f === k && (m = 4), f === k + j - 1 && (m = 6), g === h && (n = 8), a.GetBlock(f, g) === 0 ? a.SetBlock(f, g, m + n * 16) : (a.GetBlock(f, g) === 132 && a.SetBlock(f, g, 180), a.GetBlock(f, g) === 134 && a.SetBlock(f, g, 182))
        }
        return e
    }, AddEnemyLine: function (a, b, c, e) {
        for (var d = 0, f = 0, d = b; d < c; d++) if ((Math.random() * 35 | 0) < this.Difficulty + 1) f = Math.random() * 4 | 0, this.Difficulty <
        ...
        var e = (Math.random() * 10 | 0) + 5, d = this.Height - 1 - Math.random() * 4 | 0,
            f = b + 1 + Math.random() * 4 | 0, g = d - (Math.random() * 2 | 0) - 2, h = 0, i = 0, j = 0;
        e > c && (e = c);
        for (h = b; h < b + e; h++) {
            h > f + 1 && (f += 3 + (Math.random() * 4 | 0), g = d - (Math.random() * 2 | 0) - 2);
            f >= b + e - 2 && (f += 10);
            h === f && (Math.random() * 11 | 0) < this.Difficulty + 1 && a.SetSpriteTemplate(h, g, new Mario.SpriteTemplate(Mario.Enemy.Flower,
                !1));
            for (i = 0; i < this.Height; i++) if (i >= d) a.SetBlock(h, i, 145); else if ((h === f || h === f + 1) && i >= g) j = 10 + h - f, i === g ? a.SetBlock(h, i, j) : a.SetBlock(h, i, j + 16)
        }
        return e
        ...
        if (!(e < 1)) {
            ...
            d = Math.random() * 4 | 0;
            f = Math.random() * 4 | 0;
            if (e - 4 > 0 && c - 1 - f - (b + 1 + d) > 2) for (g = b + 1 + d; g < c - 1 - f; g++) g !== b + 1 && g !== c - 2 && (Math.random() * 3 | 0) === 0 ? (Math.random() * 4 | 0) === 0 ? a.SetBlock(g, e - 4, 22) : a.SetBlock(g, e - 4, 21) : (Math.random() * 4 | 0) === 0 ? (Math.random() * 4 | 0) === 0 ? a.SetBlock(g, e - 4, 18) : a.SetBlock(g, e - 4, 17) : a.SetBlock(g, e - 4, 16)
        }
    }, FixWalls: function (a) {
...
Mario.Enemy.prototype.CollideCheck = function () {
    if (this.DeadTime === 0) {
        ...
        if (a > -this.Width * 2 - 4 && a < this.Width * 2 + 4 && b > -this.Height && b < Mario.MarioCharacter.Height) if (this.Type !== Mario.Enemy.Spiky && Mario.MarioCharacter.Ya > 0 && b <= 0 && (!Mario.MarioCharacter.OnGround || !Mario.MarioCharacter.WasOnGround)) if (Mario.MarioCharacter.Stomp(this), this.Winged) this.Winged = !1, this.Ya = 0; else {
            this.YPicO = 7;
            this.PicHeight = 8;
            if (this.SpriteTemplate !== null) this.SpriteTemplate.IsDead =
                !0;
            this.DeadTime = 10;
            this.Winged = !1;
...
Mario.Mushroom.prototype.Move = function () {
    if (this.Life < 9) this.Layer = 0, this.Y--, this.Life++; else {
        this.Layer = 1;
        if (this.Xa > 2) this.Facing = 1;
        if (this.Xa < -2) this.Facing = -1;
        this.Xa = this.Facing * 1.75;
...
Mario.Shell.prototype.Move = function () {
    var a = 0;
    if (this.Carried) this.World.CheckShellCollide(this); else if (this.DeadTime > 0) {
        this.DeadTime--;
        if (this.DeadTime === 0) {
            this.DeadTime = 1;
            for (a = 0; a < 8; a++) this.World.AddSprite(new Mario.Sparkle((this.X + Math.random() * 16 - 8 | 0) + 4, (this.Y + Math.random() * 8 | 0) + 4, Math.random() * 2 - 1, Math.random() * -1, 0, 1, 5));
...
Mario.LoadingState.prototype.Update = function (a) {
    if (!this.ImagesLoaded) {
        this.ImagesLoaded = !0;
        for (var b = 0, b = 0; b < this.Images.length; b++) if (Enjine.Resources.Images[this.Images[b].name].complete !== !0) {
            this.ImagesLoaded = !1;
            break
        }
    }
    this.ScreenColor += this.ColorDirection * 255 * a;
    if (this.ScreenColor > 255) this.ScreenColor = 255, this.ColorDirection = -1; else if (this.ScreenColor < 0) this.ScreenColor = 0, this.ColorDirection = 1
};
Mario.LoadingState.prototype.Draw = function (a) {
    if (this.ImagesLoaded) a.fillStyle = "rgb(0, 0, 0)"; else {
...
Mario.WinState.prototype.Update = function (a) {
    this.drawManager.Update(a);
    if (this.waitTime > 0) this.waitTime -= a; else if (Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.S)) this.wasKeyDown = !0
};
...
Mario.MapState.prototype.GenerateLevel = function () {
    var a = 0, b = 0, c = 0, e = 0, c = c = 0, d = new Mario.ImprovedNoise(Math.random() * 9223372036854775E3 | 0),
    ...
    f = d = 9999;
    for (j = c = j = 0; j < 100 && c < 12; j++) if (a = (Math.random() * (20 / 3 | 0) | 0) * 3 + 2, b = (Math.random() * 5 | 0) * 3 + 1, this.Level[a][b] === Mario.MapTile.Grass) a < d && (d = a, f = b), this.Level[a][b] = Mario.MapTile.Level, this.Data[a][b] = -1, c++;
    this.Data[d][f] = -2;
    ...
    for (a =
             0; a < 21; a++) for (b = 0; b < 16; b++) if (this.Level[a][b] === Mario.MapTile.Grass && (a !== this.XFarthestCap || b !== this.YFarthestCap - 1)) if (c = g.PerlinNoise(a * 10 + h, b * 10 + i), c > 0) this.Level[a][b] = Mario.MapTile.Decoration;
    return !0
};
...
Mario.MapState.prototype.Connect = function (a, b, c, e) {
    for (var d = 1E4, f = 0, g = 0, h = 0, i = 0, j = 0, k = 0, h = j = 0; h < c; h++) for (i = 0; i < e; i++) this.Level[h][i] === Mario.MapTile.Level && this.Data[h][i] === -2 && (j = Math.abs(a - h) | 0, k = Math.abs(b - i) | 0, j = j * j + k * k, j < d && (f = h, g = i, d = j));
...
Mario.MapState.prototype.FindCaps = function (a, b) {
    for (var c = 0, e = 0, d = -1, f = -1, g = 0, h = 0, i = 0, c = 0; c < a; c++) for (e = 0; e < b; e++) if (this.Level[c][e] === Mario.MapTile.Level) {
        g = 0;
...
Mario.MapState.prototype.Travel = function (a, b, c, e) {
    if (!(this.Level[a][b] !== Mario.MapTile.Road && this.Level[a][b] !== Mario.MapTile.Level)) {
        if (this.Level[a][b] === Mario.MapTile.Road) if (this.Data[a][b] === 1) return; else this.Data[a][b] = 1;
        if (this.Level[a][b] === Mario.MapTile.Level) if (this.Data[a][b] > 0) this.Data[a][b] = this.LevelId !== 0 && (Math.random() * 4 | 0) === 0 ? -3 : ++this.LevelId; else if (e > 0 && (this.Data[a][b] = -1, e > this.Farthest)) this.Farthest = e, this.XFarthestCap = a, this.YFarthestCap = b;
...
Mario.MapState.prototype.Update = function (a) {
    ...
    if (this.WorldNumber !== 8) {
        ...
        if (this.MoveTime > 0) this.MoveTime--; else {
...
Mario.MapState.prototype.Draw = function (a) {
    ...
    if (this.WorldNumber !== 8) {
        ...
        for (c = 0; c <= 15; c++) for (b = 20; b >= 0; b--) if (this.Level[b][c] === Mario.MapTile.Water) {
            if (this.IsWater(b * 2 - 1, c * 2 - 1)) this.WaterSprite.X = b * 16 - 8, this.WaterSprite.Y = c * 16 - 8, this.WaterSprite.Draw(a, this.camera)
        } else if (this.Level[b][c] === Mario.MapTile.Decoration) this.DecoSprite.X = b * 16, this.DecoSprite.Y = c * 16, this.DecoSprite.Draw(a, this.camera); else if (this.Level[b][c] === Mario.MapTile.Level && this.Data[b][c] ===
...
Mario.LevelState.prototype.Update = function (a) {
    var b = 0, c = 0, e = c = 0, d = null, b = !1, d = e = c = 0, f = null, f = 0;
    this.Delta = a;
    this.TimeLeft -= a;
    ...
    if (this.Paused) for (b = 0; b < this.Sprites.Objects.length; b++) this.Sprites.Objects[b] === Mario.MarioCharacter ? this.Sprites.Objects[b].Update(a) : this.Sprites.Objects[b].UpdateNoMove(a); else {
        this.Layer.Update(a);
        this.Level.Update();
        b = !1;
        this.Tick++;
        for (c = (this.Camera.X / 16 | 0) - 1; c <= ((this.Camera.X + this.Layer.Width) / 16 | 0) + 1; c++) for (e = (this.Camera.Y / 16 | 0) - 1; e <= ((this.Camera.Y + this.Layer.Height) /
            16 | 0) + 1; e++) {
            d = 0;
        ...
        for (b = 0; b < this.ShellsToCheck.length; b++) for (c = 0; c < this.Sprites.Objects.length; c++) if (this.Sprites.Objects[c] !== this.ShellsToCheck[b] && !this.ShellsToCheck[b].Dead && this.Sprites.Objects[c].ShellCollideCheck(this.ShellsToCheck[b]) &&
        ...
        for (b = this.ShellsToCheck.length = 0; b < this.FireballsToCheck.length; b++) for (c = 0; c < this.Sprites.Objects.length; c++) this.Sprites.Objects[c] !== this.FireballsToCheck[b] && !this.FireballsToCheck[b].Dead && this.Sprites.Objects[c].FireballCollideCheck(this.FireballsToCheck[b]) && this.FireballsToCheck[b].Die();
